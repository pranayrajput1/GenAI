...
def delete_model_from_deployment(
    ...
    # print(f"Model Details: deployed_display_namREGIONe: {deployed_display_name}, endpoint_id: {endpoint_id}, "
    #       f"deployed_model_id: {deployed_model_id}")

    # undeploy_model_from_endpoint("db_scan_model_endpoint")
    # delete_endpoint_sample(project, region, "4576917261733855232")
    delete_model_sample("8652520992876265472", project, region)
