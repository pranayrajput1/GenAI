...
def fetch_and_process_feature_store_data(
    project: str,
    location: str,
    feature_view_id: str,
    ...
    logger = logging.getLogger('feature_store_data_fetcher')
    ...
    try:
        ...
        logging.info(f"Dataset Features: {df.columns}")
        logging.info(f'Task: saving data to parquet file at path: {output_csv.uri}')
